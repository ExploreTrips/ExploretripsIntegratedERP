...
<div class="modal-body">
                                ...
                                @php
                                    ...
                                    <tbody>
                                        @foreach($modules as $module)
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input align-middle ischeck staff_checkall" data-id="{{ $cleanModule }}">
                                                </td>
                                                <td>
                                                    <label class="ischeck staff_checkall" data-id="{{ $cleanModule }}">{{ ucfirst($module) }}</label>
                                                </td>
                                                <td>
                                                    <div class="row">
    ...
    @php
        ...
        // Find the permission ID where value matches $fullAction
        $key = array_search($fullAction, $permissions); // $permissions = [id => 'view user', ...]
    @endphp
...
>
            ...
            <label for="permission{{ $key }}" class="custom-control-label">{{ $label }}</label><br>
        </div>
    @endif
@endforeach
