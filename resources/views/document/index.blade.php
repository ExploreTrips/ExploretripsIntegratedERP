                                        ...
                                        <td>
                                            @can('edit document type')
                                                <div class="action-btn me-2">
                                                    <a href="#" class="mx-3 btn btn-sm align-items-center bg-info" data-url="{{ route('document.edit',$document->id)}}" data-ajax-popup="true" data-title="{{__('Edit Document Type')}}" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
                                            ...
                                            @can('delete document type')
                                                <div class="action-btn ">
                                                    <form method="POST" action="{{ route('document.destroy', $document->id) }}" id="delete-form-{{ $document->id }}">
                                                        @csrf
                                                        @method('DELETE')
