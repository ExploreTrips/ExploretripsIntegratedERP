...
@section('action-btn')
    <div class="float-end d-flex">
        <a href="#" data-size="md"  data-bs-toggle="tooltip" title="{{__('Import')}}" data-url="{{ route('employee.file.import') }}" data-ajax-popup="true" data-title="{{__('Import employee CSV file')}}" class="btn btn-lg btn-primary me-2">
            <i class="ti ti-file-import"></i>
        </a>
        <a href="#" data-bs-toggle="tooltip" title="{{__('Export')}}" class="btn btn-lg btn-primary me-2">
                            ...
                            @endphp --}}
                                <tr>
                                    ...
                                    @if($employee->company_doj)
                                        <td class="font-style">{{ \App\Helpers\CustomHelper::dateFormat($employee->company_doj )}}</td>
                                    @else
                                        <td>-</td>
                                    @endif
                                    <td>
                                        ...
                                        <td>
                                            @if($employee->is_active==1)
                                                ...
                                                <div class="action-btn ">
                                                    <form method="POST" action="{{ route('employee.destroy', $employee->id) }}" id="delete-form-{{ $employee->id }}">
                                                        @csrf
                                                        @method('DELETE')
